(ns nurt.io.jms
  ...
  or by effect handlers. Messages are JSON-serialized using nurt.internal.json and sent
  via Kane MQ with support for properties and delayed delivery."
  (:require
   [clojure.edn :as edn]
